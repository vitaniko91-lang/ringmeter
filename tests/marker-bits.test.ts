...
import { markerBits, MARKER_BITS } from '../src/kit/marker-bits'
...
describe('markerBits', () => {
  ...
  it('MARKER_BITS (the OpenCV-free copy used by the screen kit) equals the dictionary output', () => {
    expect(MARKER_BITS).toEqual(markerBits(cv))
  })
})
