...
export function Reject({ outcome: o, photo, onReset }: { outcome: R; photo?: Photo; onReset: () => void }) {
  return (
    <section aria-labelledby="reject-h" className="mt-8 rounded-md border border-error p-4">
      <p className="num text-xs font-semibold uppercase tracking-[0.15em] text-error">Retake needed · {o.code}</p>
      <h2 id="reject-h" className="mt-1 text-xl font-semibold">{o.hint}</h2>
