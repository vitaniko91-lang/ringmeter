export function Upload({ onFile, busy }: { onFile: (f: File) => void; busy: boolean }) {
  return (
    <section aria-labelledby="upload-h" className="mt-10">
      ...
      <label className="mt-4 flex min-h-14 cursor-pointer items-center justify-center rounded-md bg-accent px-6 text-base font-semibold text-white focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-accent">
