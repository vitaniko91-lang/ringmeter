export function Instructions() {
  return (
    <section aria-labelledby="how-h" className="mt-10">
      <h2 id="how-h" className="text-xl font-semibold">1–2 · Print and place</h2>
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm">
        <li><strong>Print at 100 % / Actual size</strong> — not “fit to page”. Then lay a Rp 500 coin on the SCALE CHECK circle: it must fit exactly. If it doesn't, the print is scaled and every measurement will be off.</li>
